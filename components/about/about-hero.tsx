export function AboutHero() {
    ...
    <section className="bg-gradient-to-r dark:bg-black from-blue-50 to-blue-100 py-24">
        ...
        <div className="max-w-3xl mx-auto text-center animate-fade-in">
            ...
            AImagine is a platform that uses Cloudinary's Ai features and allows the user to apply effects on their videos and images . They can download transformed videos and images . They can also get Code (currently Javascript ) for using the component in their projects.
            </p>
        </div>
        </div>
    </section>
